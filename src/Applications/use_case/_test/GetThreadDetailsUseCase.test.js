...
describe('GetThreadDetailsUseCase', () => {
  ...
  it('should orchestrating the get thread details action correctly', async () => {
    ...
    mockCommentRepository.getThreadComments = jest.fn().mockImplementation(() => Promise.resolve([
      {
        id: 'comment-123',
        username: 'dicoding',
        date: '2021-08-08T07:22:33.555Z',
    ...
    mockReplyRepository.getThreadReplies = jest.fn().mockImplementation(() => Promise.resolve([
      {
        id: 'reply-123',
        username: 'dicoding',
        date: '2021-08-08T07:22:33.555Z',
    ...
    // Action
    const threadDetails = await getThreadDetailsUseCase.execute(
      useCaseThreadId,
    );
