...
DomainErrorTranslator._directories = {
  ...
  'THREAD_DETAILS.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError(
    'tidak dapat menampilkan detail thread karena properti yang di butuhkan tidak ada',
  ),
  ...
  'COMMENT_DETAILS.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError(
    'tidak dapat menampilkan detail komentar karena properti yang di butuhkan tidak ada',
  ),
  ...
  'REPLY_DETAILS.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError(
    'tidak dapat menampilkan detail balasan karena properti yang di butuhkan tidak ada',
  ),
  'REPLY_DETAILS.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError(
    'tidak dapat menampilkan detail balasan karena tipe data tidak sesuai',
  ),
};
